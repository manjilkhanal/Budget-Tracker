...
<html>
    <head>
        <title>Monthlywise Income Report</title>
        <link rel="stylesheet" type="text/css" href="MonthlywiseIncomeReport.css">
    </head>
    <body>
        <div class="container">
            <div class="loginbox">
                <h1>Monthlywise Income Report</h1>
                <form method = "post" action = "MonthlywiseIncomeReport.php">
                    <p><?php echo $error; ?>
                    <p><?php echo $message; ?>
                    <p><?php echo $mess; ?>
                    <p>From Date:</p>
