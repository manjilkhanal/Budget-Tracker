...
<html>
    <head>
        <title>Yearlywise Expense Report</title>
        <link rel="stylesheet" type="text/css" href="YearlywiseExpenseReport.css">
    </head>
    <body>
        <div class="container">
            <div class="loginbox">
                <h1>Yearlywise Expense Report</h1>
                <form method = "post" action = "YearlywiseExpenseReport.php">
                    <p><?php echo $error; ?>
                    <p><?php echo $mess; ?>
                    <p><?php echo $message; ?>
                    <p>From Date:</p>
