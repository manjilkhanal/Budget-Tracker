...
<html>
    <head>
        <title>Daywise Income Report</title>
        <link rel="stylesheet" type="text/css" href="DaywiseIncomeReport.css">
    </head>
    <body>
        <div class="container">
            <div class="loginbox">
                <h1>Daywise Income Report</h1>
                <form method="post" action="DaywiseIncomeReport.php">
                    <p><?php echo $error; ?>
                    <p><?php echo $mess; ?>
                    <p><?php echo $message; ?>
                    <p>From Date:</p>
