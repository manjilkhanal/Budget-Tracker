...
if(isset($_POST['Submit'])){
    ...
    $error = implode("",$array);
    if(count($array) == 0){
        $sql="INSERT INTO incomefromgoods (id,no_of_item,cost_per_item,TotalAmount,Remarks) values ('$id','$no','$Cost','$Amount','$Remarks')";
	...
	<script>
        ...
        <div class="container">
            <div class="loginbox">
                ...
                <form method="post" action="incomefromgoods.php">
                    <p><?php echo $error; ?></p>
                    <p><?php echo $message; ?></p>
                    <p>No. of item</p>
                    <input type="number" name="ItemsNumber" id="ItemsNumber" placeholder="Enter no. of items" class="ItemsNumber">
                    <p>Cost per Item</p>
                    <input type="number" name="ItemsCost" id="ItemsCost" placeholder="Enter Cost Per Item" class="ItemsCost">
                    <p>Total Amount</p>
                    <input type="number" name="TotalAmount" id= "TotalAmount" placeholder="Total Amount" class="TotalAmount">
                    <p>Remarks</p>
